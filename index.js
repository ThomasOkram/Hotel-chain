...
function sortAscendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  pricing.sort(sortAscendingOrder);
  res.json(pricing);
});

function sortRatingAscendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  rating.sort(sortRatingAscendingOrder);
  res.json(rating);
});

function sortReviewOrder(hotel1, hotel2) {
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  const filteredHotel = filterByCategory(category);
